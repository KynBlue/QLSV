...
//                + "VALUES (?,?,?,?,?,?,?,?)";
        try {
            stmt.executeUpdate(sq);
//            ConnectDB.preparedStatement = ConnectDB.con.prepareStatement(sq);
//            ConnectDB.preparedStatement.setInt(1, Integer.parseInt(stID));
//            ConnectDB.preparedStatement.setString(2, stName);
//            ConnectDB.preparedStatement.setString(3, stBirth);
//            ConnectDB.preparedStatement.setInt(4, stGender.equalsIgnoreCase("false") ? 1:0);
//            ConnectDB.preparedStatement.setInt(5, Integer.parseInt(stPhone));
//            ConnectDB.preparedStatement.setInt(6, classID);
//            ConnectDB.preparedStatement.setFloat(7, Float.parseFloat(stPoint));
//            ConnectDB.preparedStatement.setInt(8, Integer.parseInt(stPoint_R));
//            ConnectDB.preparedStatement.execute();
        } catch (Exception e) {
            e.printStackTrace();
            System.err.println("Loi ham insertDB() trong studentController: " + e.getMessage());
        }
    }
...
//Ham updateStInfor()
    public void updateStInfor(Student st){
        ...
        int gender = st.getStGender().equalsIgnoreCase("Male") ? 0 : 1;
